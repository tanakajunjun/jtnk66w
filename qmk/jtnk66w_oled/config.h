...
#define VENDOR_ID       0xAB66
#define PRODUCT_ID      0x0001
#define DEVICE_VER      0x0001
#define MANUFACTURER    "tanakajunjun"
#define PRODUCT         "jtnk66w"
...
#define MATRIX_COL_PINS { F4, F5, F6, F7, B1, B3, B2, E6, B4 }
//#define UNUSED_PINS
...
#define ENCODERS_CW_KEY  { { 0, 0 }} //col,row
#define ENCODERS_CCW_KEY  { { 0, 1 }} //col,row
